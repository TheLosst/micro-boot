package ru.thelosst.authservice.services;

import io.jsonwebtoken.Claims;
import io.jsonwebtoken.Jwts;
import lombok.RequiredArgsConstructor;
import ru.thelosst.authservice.dtos.account.ClaimsRequest;
import ru.thelosst.authservice.dtos.gateway.AuthRequest;
import ru.thelosst.authservice.dtos.gateway.AuthResponse;
import ru.thelosst.authservice.dtos.gateway.RefreshRequest;
import ru.thelosst.authservice.exceptions.AppError;
import ru.thelosst.authservice.utils.JwtTokenUtil;
